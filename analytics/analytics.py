...
from ui.top_customers import show_top_customers_interface  # Import the function to show top customers
from ui.ui_config import apply_styles
from ui.upcoming_birthdays import show_upcoming_birthdays
